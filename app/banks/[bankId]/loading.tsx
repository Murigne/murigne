  ...
  return (
    <NavigationShell>
      <div className="space-y-6">
        ...
        <Card aria-busy="true" className="murigne-card-pad">
          <div className="murigne-skeleton h-8 w-44 rounded-md" />
          <div className="murigne-skeleton mt-6 h-56 w-full rounded-xl" />
        </Card>
      </div>
    </NavigationShell>
  );
